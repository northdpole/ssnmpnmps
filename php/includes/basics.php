...
function get_results_for_oid_host($host, $oid){
	$query = "SELECT * FROM host_service_results WHERE ipaddress ='".mysql_real_escape_string($host)."' AND oid='".mysql_real_escape_string($oid)."'";
	 return mysql_query($query);
}
function get_oids_for_host($host){
	$query = "SELECT * FROM host_services WHERE ipaddress ='".mysql_real_escape_string($host)."'";
	 return mysql_query($query);
}
function get_user_by_username_and_password($username, $password) {
	$query = "SELECT * FROM users WHERE (name = '" . mysql_real_escape_string($username) . "' and password = '" . mysql_real_escape_string($password) . "')";
    return mysql_query($query);
}
...
function redirect_to($location = "index.php") {
		error_log("redirection to index");
